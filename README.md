...
<ul>
	...
	<li><a href="">Using multiple APIs with Azure AD auth in Angular and ASP.NET Core</a></li>

</ul>

## History

2020-12-05 Added Using multiple APIs with Azure AD auth in Angular and ASP.NET Core
